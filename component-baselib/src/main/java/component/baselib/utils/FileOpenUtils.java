...
/**
 * Created by MouShao on 2018/9/10.
 */
...
public class FileOpenUtils {
    ...
    public static void openFileByPath(Context context, String path) {
        ...
        if (!file.exists()) {
            ToastUtils.showToast(context, "当前文件已被清理");
            return;
        }
        ...
        try {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {//如果SDK版本>=24，即：Build.VERSION.SDK_INT >= 24
                uri = FileProvider.getUriForFile(context.getApplicationContext(), "com.pvirtech.police.ch.fileprovider", new File(path));
            ...
            ToastUtils.showToast(context, "无法打开该格式文件!");
            e.printStackTrace();
        }
    }
