...
public class PictureSelectorActivity extends PictureBaseActivity implements View.OnClickListener,
    ...
    private void initView(Bundle savedInstanceState) {
        ...
        mediaLoader = new LocalMediaLoader(this, config.mimeType, config.isGif, config.videoMaxSecond, config
                .videoMinSecond);
        rxPermissions.request(Manifest.permission.READ_EXTERNAL_STORAGE)
                .subscribe(new Observer<Boolean>() {
                    @Override
    ...
    public void startPreview(List<LocalMedia> previewImages, int position) {
        ...
        switch (mediaType) {
            case PictureConfig.TYPE_IMAGE:
                ...
                startActivity(PicturePreviewActivity.class, bundle,
                        config.selectionMode == PictureConfig.SINGLE ? UCrop.REQUEST_CROP : UCropMulti
                                .REQUEST_MULTI_CROP);
                overridePendingTransition(R.anim.a5, 0);
                break;
            case PictureConfig.TYPE_VIDEO:
